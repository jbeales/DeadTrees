 ...
 */	
	...
	public function validate_send_bookbox_css($input) {
		if('yes' == $input) {
			return true;
		}
	...
	public function send_bookbox_css_explanation() {
		echo '<p>';
		_e('We can include styles for the default code generated by the template tag dt_bookbox(), which prints out a link to the current book on Amazon. This box chooses whether you want those styles to be sent or not.', 'deadtree');
		echo '</p>';
	}
	...
	public function setup_settings() {
		...
		register_setting('deadtree_options', 'dt_send_bookbox_css', array(&$this, 'validate_send_bookbox_css'));
		add_settings_section('dt_send_bookbox_css', __('Include Default Bookbox CSS', 'deadtree'), array(&$this, 'send_bookbox_css_explanation'), 'deadtree');
		add_settings_field('dt_send_bookbox_css', __('Check to include default Bookbox CSS', 'deadtree'), array(&$this, 'populate_send_bookbox_css'), 'deadtree', 'dt_send_bookbox_css');
